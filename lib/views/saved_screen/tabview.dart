    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            Padding(
              padding: EdgeInsets.symmetric(vertical: SizeUtils.height * 0.015),
              child: TabBar(
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      crossAxisSpacing:
                          12.0, // Space between items horizontally
                        ...
                        Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              fit: BoxFit
                                  .contain, // Scales image to fit container
